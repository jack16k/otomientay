                ...
                <div class="row" id="block_new">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h2 class="block_title">{{$cate->c_name}}</h2>
                        </div>
                        <div class="panel-body">
                            ...
                            <div class="row post">
                                <div class="col-sm-4 padding_10">
                                    <a href="<?php echo url('/').'/'.$cate->c_alias.'/'. $post->p_alias;?>">
                                        <img class="img-responsive" src="{{$post->p_image}}">
                                    </a>
                                </div>
                                <div class="col-sm-8 padding_10">
                                    <a href="<?php echo url('/').'/'.$cate->c_alias.'/'. $post->p_alias;?>"><h4>{{$post->p_title}}</h4></a>
                                    <p class="p_description">{{$post->p_description}}</p>
                                    <a href="<?php echo url('/').'/'.$cate->c_alias.'/'. $post->p_alias;?>" class="btn-readmore">Xem thêm</a>
                                </div>
                            </div>
